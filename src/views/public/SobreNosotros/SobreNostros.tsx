    ...
    <main className="font-Nunito">
          ...
          <StepperPanel header="Nuestros Valores">
            <div className="flex flex-column h-auto">
              <div className="border-2 border-dashed surface-border border-round surface-ground flex-auto flex flex-col justify-content-center align-items-center font-medium text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-center pb-5">
                  <Card title="Transparencia" className="max-sm:w-56 w-60 md:w-64 mx-auto flex flex-col justify-center">
                    <p className="m-0">
                      Fomentamos la confianza a través de una comunicación clara y abierta en cada paso.
                    </p>
                  </Card>
                  <Card title="Innovación" className="max-sm:w-56 w-60 md:w-64 mx-auto">
                    <p className="m-0">
                      Utilizamos tecnología de punta para mejorar la experiencia de nuestros usuarios.
                    </p>
                  </Card>
                  <Card title="Compromiso" className="max-sm:w-56 w-60 md:w-64 mx-auto">
                    <p className="m-0">
                      Nos dedicamos a ofrecer excelencia en todos nuestros servicios.
                    </p>
                  </Card>
                  <Card title="Responsabilidad" className="max-sm:w-56 w-60 md:w-64 mx-auto">
                    <p className="m-0">
            ...
            <div className="flex pt-5 justify-content-start">
              <Button label="Volver" severity="secondary" icon="pi pi-arrow-left" onClick={() => stepperRef.current.prevCallback()} />
            </div>
          </StepperPanel>
        </Stepper>
      ...
      <section className="p-5 md:p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-x-20 gap-y-10 text-center">
          ...
          <div className="card mx-auto">
            <Fieldset legend={legendTemplate("Luis Gomez", "Luis.png")} className="md:w-72 lg:w-96 pt-0">
              <h1 className="m-0 text-lg lg:text-xl font-semibold">Director de producto</h1>
              <p className="m-0">
          ...
          <div className="card mx-auto">
            <Fieldset legend={legendTemplate("Manuel Pasos", "Manuel.png")} className="md:w-72 lg:w-96 pt-0">
              <h1 className="m-0 text-lg lg:text-xl font-semibold">Director de tecnología</h1>
              <p className="m-0">
          ...
          <div className="card mx-auto">
            <Fieldset legend={legendTemplate("Misael Rosado", "Misael.png")} className="md:w-72 lg:w-96 pt-0">
              <h1 className="m-0 text-lg lg:text-xl font-semibold">Gerente de soporte</h1>
              <p className="m-0">
